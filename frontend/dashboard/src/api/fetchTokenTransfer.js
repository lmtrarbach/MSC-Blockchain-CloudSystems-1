...
const fetchTokenTransfer = async (address) => {
    try {
      ...
      const startDate = new Date(currentDate.getTime() - (4 * 24 * 60 * 60 * 1000)).toISOString().slice(0, 10);
      const pastDate = new Date((currentDate.getTime() - (4 * 24 * 60 * 60 * 1000)) - (9 * 24 * 60 * 60 * 1000)); // Subtract 7 days
